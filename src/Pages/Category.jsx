...
export default function Category() {
  ...
  const handleData = (values) => {
    if (id != null) {
      axios.patch("https://interviewback-ucb4.onrender.com/category/" + id, values, {
        headers: {
          Authorization: token
        }
      })
  ...
  const subcatstatus = (filterData) => {
    ...
    for (let i = 0; i < filterData.length; i++) {
      ...
      axios.patch("https://interviewback-ucb4.onrender.com/subcatagory/" + id, {
  ...
  const getSubfilter = (el) => {
    axios.get("https://interviewback-ucb4.onrender.com/subcatagory/", {
      headers: {
        Authorization: token
      }
    })
  ...
  const filteredData = data.filter((el) =>
    el.categoryName.toLowerCase().includes(searchvalue.toLowerCase())
  );
